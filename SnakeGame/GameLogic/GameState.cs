...
public class GameState
{
    ...
    private Direction GetLastDirection()
    {
        ...
        return dirBuffer?.Last?.Value ?? throw new ArgumentNullException(nameof(dirBuffer.Last.Value));
    }
    ...
    public void MoveSnake()
    {
        if (dirBuffer.Count > 0)
        {
            Dir = dirBuffer?.First?.Value ?? throw new ArgumentNullException(nameof(dirBuffer.First.Value));
